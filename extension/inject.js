...
(() => {
  ...
  // Only check while the tab is visible — hidden tabs can't issue user fetches,
  // and SPAs stay open for days. 30s is fast enough to recover from a real
  // tamper without burning ~17k iterations/day on idle background tabs.
  setInterval(() => {
